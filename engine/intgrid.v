...
pub fn IntGrid.instantiate(app &App, name string) &IntGrid {
	return &IntGrid{
		app:       app
		node_name: name
	}
...
// if that result came from one of this IntGrid's cell bodies.
// returns 0 if the collision was not against this IntGrid.
@[inline]
