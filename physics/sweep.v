...
pub fn sweep_aabb(mover AABB, obstacle AABB, vel_x f32, vel_y f32) SweepResult {
	...
	if !lb_clip(-vel_x, px - diff_min_x, mut ti1, mut ti2, mut nx, mut ny, -1, 0) {
		return SweepResult{}
	}
	if !lb_clip(vel_x, diff_max_x - px, mut ti1, mut ti2, mut nx, mut ny, 1, 0) {
		return SweepResult{}
	}
	if !lb_clip(-vel_y, py - diff_min_y, mut ti1, mut ti2, mut nx, mut ny, 0, -1) {
		return SweepResult{}
	}
	if !lb_clip(vel_y, diff_max_y - py, mut ti1, mut ti2, mut nx, mut ny, 0, 1) {
		return SweepResult{}
	}
