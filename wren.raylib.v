...
fn color_wren_get_r(vm &wren.VM) {
	vm.set_slot_double(0, wren_get_color(vm, 0).r)
}

fn color_wren_get_g(vm &wren.VM) {
	vm.set_slot_double(0, wren_get_color(vm, 0).g)
}

fn color_wren_get_b(vm &wren.VM) {
	vm.set_slot_double(0, wren_get_color(vm, 0).b)
}

fn color_wren_get_a(vm &wren.VM) {
	vm.set_slot_double(0, wren_get_color(vm, 0).a)
}
