...
pub fn AudioServer.new() AudioServer {
	...
	s.buses['master'] = AudioBus{
		name: 'master'
		send: ''
	}
	s.buses['music'] = AudioBus{
		name: 'music'
		send: 'master'
	}
	s.buses['sfx'] = AudioBus{
		name: 'sfx'
		send: 'master'
	}
	return s
